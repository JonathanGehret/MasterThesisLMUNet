...
def optimize_one_landscape(train_loader, input_data, model, optimizer, loss_fn, accumulation_steps=1, device='cuda'):
...
#with original landscape
def optimize_one_landscape_no_tqdm(target_metric, input_data, model, optimizer, loss_fn, device='cuda'):
